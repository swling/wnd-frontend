...
// basic
require WND_PATH . 'includes/wnd-database.php'; //数据库
require WND_PATH . 'includes/wnd-options.php'; //配置选项
require WND_PATH . 'includes/wnd-api.php'; // API
...
require WND_PATH . 'templates/tpl-admin.php'; //前端管理模板
