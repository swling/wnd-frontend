...
class Wnd_Account_Form extends Wnd_Module_Form {
	...
	protected static function configure_form(): object{
		...
		$form->add_text(['value' => $user->ID, 'label' => 'User ID', 'disabled' => true]);
		$form->add_text(['value' => $user->data->user_login, 'label' => 'Account', 'disabled' => true]);
		...
		$form->set_route('action', 'user/wnd_update_account');
