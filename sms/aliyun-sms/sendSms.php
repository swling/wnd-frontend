...
// fix 2018.1.22 命名空间必须是第一条语句，但本文件是通过外部require调用，因此不得含有命名空间

require dirname(__FILE__)."/core/SignatureHelper.php";
...
// set_time_limit(3); // 防止脚本超时，仅用于测试使用，生产环境请按实际情况设置
// header("Content-Type: text/plain; charset=utf-8"); // 输出为utf-8的文本格式，仅用于测试

// 验证发送短信(SendSms)接口
// print_r(sendSms('13075490410','1016'));